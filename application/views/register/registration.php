                            ...
                            <div class="col-sm-12 col-sm-offset-0 alert_msg"></div>
                             <fieldset>
                                <div class="form-group">
                                    ...
                                    <input type="text" name="email" placeholder=" Email or Username" class="f1-email form-control mandatory-field" id="email" onchange="isEmail()">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" name="password" placeholder=" Password" class="f1-password form-control mandatory-field" id="password">
                                    <span class="help-inline col-xs-12 col-sm-7">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" name="repassword" placeholder=" Repeat password" class="f1-repeat-password form-control mandatory-field" id="repassword">
                                    <span class="help-inline col-xs-12 col-sm-7">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input type="text" onblur="javascript:return check_ismobile(event,this,0);" name="mobile" placeholder=" Mobile No." class="f1-mobile form-control"  id="mobile" onKeyUp="javascript:return check_isnumeric(event,this,0);" maxlength="10">
                                    <span class="help-inline col-xs-12 col-sm-7">
