              ...
              <span class="color blue"></span>
                    ...
                    <span class="color"> 
                      <div class="sp-quantity">
                        ...
                        <div class="action">
              <button class="btn-cart1 pull-left" type="button" data-toggle="tooltip" title="Add To Cart"><i class="fa fa-cart-arrow-down"></i> &nbsp;Add To Cart</button>
              <button class="btn-cw pull-left" type="button" data-toggle="tooltip" title="Wishlist"><span class="fa fa-heart"></span></button>
