            ...
            <div id="primary-menu">
              ...
              <nav id="main-menu">
                <ul id="menu-main-menu" class="menu">
                  <li class="current_page_item menu-item-simple-parent menu-item-depth-0"><a href="<?php echo base_url();?>">Home</a>
                    <!--<ul class="sub-menu">
                  ...
                  <li class="menu-item-megamenu-parent  megamenu-4-columns-group menu-item-depth-0"> <a href="<?php echo base_url('cmaster/aboutUs');?>">About</a>
                    ...
                    <a class="dt-menu-expand">+</a> </li>
                     ...
                     <li class="menu-item-megamenu-parent  megamenu-4-columns-group menu-item-depth-0"> <a href="<?php echo base_url('programs/programView');?>" title=""> Programs </a>
                    <div class="megamenu-child-container">
                      <ul class="sub-menu">
                        <li>
                    ...
                    <li class="menu-item-megamenu-parent  megamenu-4-columns-group menu-item-depth-0"> <a href="<?php echo base_url('packages/packagesView');?>">Packages</a>
                    <div class="megamenu-child-container">
                      <ul class="sub-menu">
                    ...
                    <li class="menu-item-megamenu-parent  megamenu-4-columns-group menu-item-depth-0"> <a href="<?php echo base_url('product/productView');?>" title=""> Fitness Products </a>
                    <div class="megamenu-child-container">
                      <ul class="sub-menu">
                        <li>
                  ...
                  <li class="menu-item-simple-parent menu-item-depth-0"><a href="<?php echo base_url('Testimonials/testimonialsView');?>">Success Stories </a>
                    <a class="dt-menu-expand">+</a> </li>
                  <li class="menu-item-megamenu-parent  megamenu-4-columns-group menu-item-depth-0"> <a href="<?php echo base_url('cmaster/gallery');?>" title=""> Gallery </a>
                    
                    <a class="dt-menu-expand">+</a> </li>
                  <li class="menu-item-simple-parent menu-item-depth-0"><a href="<?php echo base_url('contactUs/contactUsView');?>">Contact</a></li>
                </ul>
              </nav>
            </div>
          </div>
