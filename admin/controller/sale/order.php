			...
			if ($order_info && $order_info['shipping_code']) {
				...
				foreach ($products as $product) {
					...
					if ($product_info) {
						...
						//echo "test3";
						foreach ($options as $option) {
							$option_value_info = $this->model_catalog_product->getProductOptions($order_id, $product['order_product_id']);
							//print_r($option);
							//echo "test4";
							if ($option['type'] != 'file') {
								$value = $option['value'];
							...
							$product_option_value_info = $this->model_catalog_product->getProductOptions($product['product_id'], $option['product_option_value_id']);
